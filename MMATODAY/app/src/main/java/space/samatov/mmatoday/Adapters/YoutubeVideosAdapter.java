...
public class YoutubeVideosAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<YouTubeThumbnailClicked> mListeners=new ArrayList<>();

    public void addListeners(YouTubeThumbnailClicked listener){
        mListeners.add(listener);
    }

    public YoutubeVideosAdapter(ArrayList<YoutubeVideo> list){
        mVideoList=list;
    }
    ...
    private void notifyListeners(YoutubeVideo video){
     for (YouTubeThumbnailClicked listener:mListeners)
